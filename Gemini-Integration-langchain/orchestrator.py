...
def main():
    ...
    if not os.path.exists(initial_tal_file_path):
        print(f"Error: Initial TAL file not found at {initial_tal_file_path}")
        return
    ...
    if not documented_tal_path: print("Orchestration failed at Agent 1."); return
    ...
    if not tal_tech_spec_path: print("Orchestration failed at Agent 2."); return
    ...
    if not java_tech_spec_path: print("Orchestration failed at Agent 3."); return
    ...
    if not java_code_path: print("Orchestration failed at Agent 4."); return
    ...
    if not flow_diagram_path: print("Orchestration failed at Agent 5."); return
    ...
    if not test_data_path: print("Orchestration failed at Agent 6."); return
    ...
    if not unit_tests_path: print("Orchestration failed at Agent 7."); return # Add failure check
